...
export const RecipeCard = ({ recipe }: RecipeProps) => {
  ...
  return (
    <div
      ...
      className={`relative w-68 rounded-xl overflow-hidden shadow-lg bg-white hover:shadow-xl transition-shadow duration-300 ${isSelected ? "ring-4 ring-blue-500" : ""}`}
    >
      ...
      <div data-testid="recipe-clickable" className="p-4 flex flex-col justify-between h-28 cursor-pointer" onClick={() => goToRecipe()}>
