...
// import { RECIPE_DTO_MOCK } from 'src/mocks/collection.mock';
...
//       const { id: _, ...collectionWithoutId } = RECIPE_DTO_MOCK;
...
//       await collectionModel.insertOne(RECIPES_DOCUMENT_MOCK[0]);
//       // eslint-disable-next-line @typescript-eslint/no-unused-vars
//       const { id: _, ...collectionWithoutId } = RECIPE_DTO_MOCK;
...
//       await collectionModel.insertMany(RECIPES_DOCUMENT_MOCK);
...
//       const doc = await collectionModel.insertOne(RECIPES_DOCUMENT_MOCK[0]);
